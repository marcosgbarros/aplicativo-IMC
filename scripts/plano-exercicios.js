...
document.getElementById('exerciseForm').addEventListener('submit', async function(e) {
  ...
  se for musculação, fazer serie de 6 exercícios por dia seguindo a regra de treino. traduza os nomes em inglês para o português caso nao sejam conhecidos.
  - Idade: ${age}
  - Sexo: ${sex}
  - IMC: ${imc}
